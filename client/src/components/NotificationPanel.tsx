...
const NotificationPanel: React.FC = () => {
  ...
  const readHandler = () => {};
  const viewHandler = (item: Notification) => {}; // Ensure proper type for item
  ...
  const callsToAction: {
    ...
    { name: "Cancel", href: "#", icon: "" },
    {
      ...
      href: "#",
      icon: "",
      onClick: () => readHandler("all", ""), // Ensure proper parameters
    },
  ];
                  ...
                  <div className="p-4">
                    {data?.slice(0, 5).map((item, index) => (
                      <div
                        ...
                        onClick={() => viewHandler(item)} // Ensure proper onClick handling
                      >
