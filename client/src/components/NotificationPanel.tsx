...
interface Notification {
  ...
  team: string[];
  text: string;
  task: null | { _id: string; title: string };
...
const ICONS: Record<"alert" | "message", JSX.Element> = {
  alert: (
...
const NotificationPanel: React.FC = () => {
  ...
  const readHandler = () => {};
  const viewHandler = (item: Notification) => {
    setSelected(item);
    setOpen(true);
  };
  ...
  // Ensure that open and selected values are read
