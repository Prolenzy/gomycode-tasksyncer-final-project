...
interface ConfirmationDialogProps {
  ...
  setType?: React.Dispatch<React.SetStateAction<"delete" | "restore" | "restoreAll" | undefined>>;
}

const ConfirmatioDialog: React.FC<ConfirmationDialogProps> = ({
  open,
  setOpen,
  msg,
  setMsg = () => {},
...
export const UserAction: React.FC<UserActionProps> = ({ open, setOpen, onClick = () => {} }) => {
  const closeDialog = () => {
    setOpen(false);
  };
