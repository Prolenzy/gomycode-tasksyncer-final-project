    ...
    return (
        <div>
            ...
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-4xl font-bold mb-8 mt-11 text-center">Welcome to TaskSyncer!</h1>

                {/* Card List */}
                <div className="flex flex-col md:flex-row gap-4">
                    {/* Card 1 */}
                    <div className="bg-blue-200 rounded-lg p-4 flex-1">
                        <h2 className="text-xl font-semibold mb-2">Introducing TaskSyncer</h2>
                    ...
                    {/* Card 2 */}
                    <div className="bg-blue-200 rounded-lg p-4 flex-1">
                        <h2 className="text-xl font-semibold mb-2">Effortless Task Organization</h2>
                    ...
                    {/* Card 3 */}
                    <div className="bg-blue-200 rounded-lg p-4 flex-1">
                        <h2 className="text-xl font-semibold mb-2">Join Thousands of Satisfied Users</h2>
